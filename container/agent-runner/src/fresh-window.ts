/**
 * Zero-summary fresh-window helpers.
 *
 * These format a structured handoff for a clean SDK session/window. They do
 * not summarize history and do not replace model-aware auto-compact.
 */
